...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-100 to-base-200 flex items-center justify-center p-4 mt-10">
      <motion.div
      ...
      >
          ...
          >
            {skills.map((skill, index) => (
              <motion.span
                ...
                className="px-4 py-2 bg-base-300 text-base-content rounded-full text-sm font-medium cursor-default transition-colors"
                custom={index}
              >
                {skill}
              </motion.span>
        ...
        >
          <motion.a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-base-300 hover:bg-base-content hover:text-base-100 rounded-lg transition-all duration-300"
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-all duration-300"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
          ...
          <motion.a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-all duration-300"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
